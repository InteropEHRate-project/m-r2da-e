...
public class MainActivity extends AppCompatActivity implements MR2DACallbackHandler  {
    ...
    private Runnable buttonEnabler = new EnableExecButton();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton patientSummaryRadio = (RadioButton) findViewById(R.id.psRadio);
        ...
        execButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RadioGroup opsGroup = (RadioGroup) findViewById(R.id.opsRadioGroup);
                RadioButton encEverythingRadio = (RadioButton) findViewById(R.id.encEverythingRadio);
                RadioButton encSearchRadio = (RadioButton) findViewById(R.id.encSearchRadio);
                RadioButton patientSummaryRadio = (RadioButton) findViewById(R.id.psRadio);
                SendRequestToR2DAccess asyncTask = new SendRequestToR2DAccess();

                int checkedRadioButtonId = opsGroup.getCheckedRadioButtonId();
                if (checkedRadioButtonId <= 0) {
                    Snackbar snackbar = Snackbar.make(findViewById(R.id.executeButton),
    ...
    private class SendRequestToR2DAccess extends AsyncTask<Object, Void, Void> {
        ...
        protected Void doInBackground(Object... objects) {
            ...
            try {
                if (operation.equals("PATIENT_SUMMARY"))
                    mr2da.getPatientSummary();
                else if (operation.equals("ENCOUNTER_EVERYTHING"))
                    mr2da.getEncounterEverything((String)objects[1]);
                else if (operation.equals("ENCOUNTER_SEARCH"))
    ...
    @Override
    public void onPatientSummaryCompleted(org.hl7.fhir.r4.model.Bundle bundle) {
        String msg = "onPatientSummaryCompleted: received bundle with "
                + bundle.getEntry().size() + " items.";
        Log.i("MR2DA.CallbackHandler", msg);
        this.runOnUiThread(buttonEnabler);
        Snackbar.make(execButton, msg, Snackbar.LENGTH_INDEFINITE).show();
    ...
    @Override
    public void onPatientEverythingCompleted(org.hl7.fhir.r4.model.Bundle bundle) {
        String msg = "onPatientEverythingCompleted: received bundle with "
                + bundle.getEntry().size() + " items.";
        Log.i("MR2DA.CallbackHandler", msg);
        this.runOnUiThread(buttonEnabler);
        Snackbar.make(execButton, msg, Snackbar.LENGTH_INDEFINITE).show();
    ...
    @Override
    public void onEncounterEverythingCompleted(org.hl7.fhir.r4.model.Bundle bundle) {
        String msg = "onEncounterEverythingCompleted: received bundle with "
                + bundle.getEntry().size() + " items.";
        Log.i("MR2DA.CallbackHandler", msg);
        this.runOnUiThread(buttonEnabler);
        Snackbar.make(execButton, msg, Snackbar.LENGTH_INDEFINITE).show();
    ...
    @Override
    public void onDiagnosticReportEverythingCompleted(org.hl7.fhir.r4.model.Bundle bundle) {
        String msg = "onDiagnosticReportEverythingCompleted: received bundle with "
                + bundle.getEntry().size() + " items.";
        Log.i("MR2DA.CallbackHandler", msg);
        this.runOnUiThread(buttonEnabler);
        Snackbar.make(execButton, msg, Snackbar.LENGTH_INDEFINITE).show();
    ...
    @Override
    public void onCompositionDocumentCompleted(org.hl7.fhir.r4.model.Bundle bundle) {
        String msg = "onCompositionDocumentCompleted: received bundle with "
                + bundle.getEntry().size() + " items.";
        Log.i("MR2DA.CallbackHandler", msg);
        this.runOnUiThread(buttonEnabler);
        Snackbar.make(execButton, msg, Snackbar.LENGTH_INDEFINITE).show();
