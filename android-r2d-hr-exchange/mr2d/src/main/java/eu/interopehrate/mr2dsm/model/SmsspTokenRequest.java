...
public class SmsspTokenRequest {
    ...
    private eu.interopehrate.mr2dsm.model.SPType SPType;
    private String version;
    private RequestedAuthenticationContext requestedAuthenticationContext;

    public SmsspTokenRequest(List<Attribute> attribute_list, String citizen_country, String created_on, Boolean force_authentication, UUID id, NameIDPolicy nameIDPolicy, String provider_name, String serviceUrl, eu.interopehrate.mr2dsm.model.SPType SPType, String version, RequestedAuthenticationContext requestedAuthenticationContext) {
    ...
    public eu.interopehrate.mr2dsm.model.SPType getSPType() {
        return SPType;
    }

    public void setSPType(eu.interopehrate.mr2dsm.model.SPType SPType) {
        this.SPType = SPType;
    }
